...
Object.keys(sanitizers).forEach(function (sanitizer) {
  var func = sanitizers[sanitizer]

  Assurance.prototype[sanitizer] = function runSanitizer() {
    if (this._skip) {
      return this
    }
    ...
    var newVal = func.apply(null, args)
...
Object.keys(validators).forEach(function (validator) {
  var func = validators[validator]
  
  Assurance.prototype[validator] = function runValidator() {
    if (this._skip) {
      return this
    }
    ...
    if (err instanceof Error) {
      ...
      throw new Error('validator ' + validator + ' didnt return undefined nor Error')
    }
